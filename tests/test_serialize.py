from inflammation import models, serialize
...
def test_patients_json_serializer():
    ...
    serialize.PatientJSONSerializer.save(patients, output_file)
    patients_new = serialize.PatientJSONSerializer.load(output_file)
